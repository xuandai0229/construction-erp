...
export default function InventoryPage() {
  ...
  return (
    <EnterpriseAppShell activeItem="inventory">
      <EnterpriseHeader
        title="QUẢN TRỊ KHO & VẬT TƯ CÔNG TRÌNH"
        subtitle="Hệ thống theo dõi xuất nhập tồn, giá bình quân di động, đối chiếu sổ cái TK 152"
      />
