  ...
  return (
    <EnterpriseAppShell activeItem="vouchers">
      <EnterpriseHeader
        ...
        subtitle="Quản lý và hạch toán dòng tiền tạm ứng, nghiệm thu, hóa đơn VAT thầu phụ, nhà cung cấp dự án"
      />
      <EnterprisePageContainer>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between pb-4 border-b border-[var(--border)]">
          <div>
            <h1 className="text-sm font-bold tracking-tight text-[var(--text-primary)]">Tổng hợp công nợ nhà thầu</h1>
