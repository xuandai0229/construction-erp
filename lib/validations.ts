import { z } from "zod";
import { ProjectStatus, TaskStatus, CostType, PaymentStatus, InvoiceStatus, UserRole } from "../generated/prisma-client";
...
export const createProjectSchema = z.object({
  ...
  ownerId: z.string().uuid("ID người phụ trách không hợp lệ").optional(),
...
export const createTaskSchema = z.object({
  ...
  assigneeId: z.string().uuid("ID người thực hiện không hợp lệ").optional(),
